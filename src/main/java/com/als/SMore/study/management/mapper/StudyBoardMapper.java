...
public class StudyBoardMapper {
    ...
    public static StudyBoard updateStudyBoard(StudyBoard studyBoard, StudyBoardUpdateDTO studyBoardUpdateDTO, String imageUrl) {
        String adSummary = studyBoardUpdateDTO.getAdContent() != null && studyBoardUpdateDTO.getAdContent().length() > 30
                ? studyBoardUpdateDTO.getAdContent().substring(0, 30) + "..."
                : studyBoardUpdateDTO.getAdContent() != null ? studyBoardUpdateDTO.getAdContent() : studyBoard.getAdContent();
